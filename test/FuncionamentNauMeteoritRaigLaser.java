...
public class FuncionamentNauMeteoritRaigLaser {
	JFrame f_;
	Canvas c_;
	Nau n_;
	Meteorit m_;
	...
	{
		FuncionamentNauMeteoritRaigLaser t = new FuncionamentNauMeteoritRaigLaser();
		t.jugar();
	}
	
	FuncionamentNauMeteoritRaigLaser() throws Exception
	{
