...
s\textquotesingle{}ha centrat el triangle a l\textquotesingle{}area amplada$\ast$altura 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
retorna la distancia entre el centre de la \hyperlink{class_nau}{Nau} i el punt (x,y) 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
Es frena el moviment de la \hyperlink{class_nau}{Nau} determinat per una resistencia que és directament proporcional a la velocitat de la \hyperlink{class_nau}{Nau}. 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
retorna una taula(t\mbox{[}0..nombre\+Punts\+\_\+$\ast$2-\/1) que conte els punts del triangle 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
la velocitat rotaciona de la \hyperlink{class_nau}{Nau} és 0 (no rota en cap sentit) 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
La \hyperlink{class_nau}{Nau} és viva, apunta cap a dalt, està parada i te la punta superior a la coordenada (a/2) 
\end{DoxyPostcond}
