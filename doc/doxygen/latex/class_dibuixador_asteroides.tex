...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
dibuixa a la superficie de la finestra del Dibuixa\+Asteroides puntuacio al marge esquerre superior. 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
pinta a la superficie de la finestra del Dibuixa\+Asteroides amb el color de fons i mostra m de color blanc 
\end{DoxyPostcond}
